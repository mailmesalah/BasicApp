...
namespace WpfAccountServerApp
{
    ...
    public partial class Database9001Entities : DbContext
    {
        public Database9001Entities()
            : base("name=Database9001Entities")
        {
        }
        ...
        public virtual DbSet<barcode_table> barcode_table { get; set; }
