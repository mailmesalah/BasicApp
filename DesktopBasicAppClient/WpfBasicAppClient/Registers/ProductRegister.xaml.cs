        ...
        private void saveDataToDatabase()
        {
            ...
            {                
                ...
                using (ChannelFactory<IProduct> ProductProxy = new ChannelFactory<ServerServiceInterface.IProduct>("ProductEndpoint"))
                {
                    ...
                    ccr.StockInUnitCode = mProductType == "AGroup" ? "" : mComboPurchaseUnit.SelectedValue.ToString();
                    ccr.StockOutUnitCode = mProductType == "AGroup" ? "" : mComboSalesUnit.SelectedValue.ToString();
